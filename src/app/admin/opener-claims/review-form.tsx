...
import { reviewOpenerFileClaimAction } from "@/app/portal/files/opener-claim-actions";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";

export function OpenerClaimReviewForm({
  claimId,
  pending,
}: {
  claimId: string;
  ...
  function review(decision: "accepted" | "rejected") {
    ...
    start(async () => {
      const res = await reviewOpenerFileClaimAction(null, fd);
      if (!res) return;
